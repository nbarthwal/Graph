...
public:
    ...
    Plot(const Graph* canvas, const float minP, const float maxP):
...
public:
    DynamicPlot(const Graph* canvas, Graph::DynamicData& ptr):
...
void Graph::Plot(DynamicData& data)
{
...
public:
    StaticPlot(const Graph* canvas, const vector<Graph::Data>& d):
...
void Graph::Plot(const vector<Graph::Data>& data)
{
