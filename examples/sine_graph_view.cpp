...
public:
    ...
    float MaxX() const override { return 6.28318f; }
    float MinX() const override { return 0.0f; }
    std::string Color() const override { return color_; }
    float Value(float p, float x) const override { return p * std::sin(frequency_ * x); }
    bool Point() const override { return point_; }
...
public:
    ...
    float MaxX() const override { return 6.28318f; }
    float MinX() const override { return 0.0f; }
    float MaxY() const override { return 2.0f; }
    float MinY() const override { return -2.0f; }
